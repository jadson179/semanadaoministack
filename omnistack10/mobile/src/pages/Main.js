    ...
    return (
        <>
         ...
         <View style={styles.searchForm}>
             <TextInput style={styles.searchInput} placeholder="Buscar devs por techs" autoCapitalize="words"placeholderTextColor="#999" autoCorrect={false} value={techs} onChangeText={text => setTechs(text)} />
